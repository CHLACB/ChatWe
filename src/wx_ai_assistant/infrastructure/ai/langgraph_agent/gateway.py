...
class LangGraphAiGateway(AiGateway):
    ...
    def __init__(
        ...
        self.graph = graph or build_wechat_reply_graph(self.client, policy_loader=self.policy_loader)
    ...
    def _save_decision_log(self, snapshot: dict[str, Any]) -> None:
        ...
        try:
            ...
            print(f"warning ai_decision_log_save_failed run_id={snapshot.get('run_id')!r} error={exc}", flush=True)
